...
class BasicRFB(nn.Module):
    def __init__(self, in_planes, out_planes, stride=1, scale=0.1, visual=1):
        ...
        self.branch0 = nn.Sequential(
                ...
                BasicConv(2 * inter_planes, 2 * inter_planes, kernel_size=(1, 3), stride=1, padding=(0, visual), dilation=visual, relu=False),
                BasicConv(2 * inter_planes, 2 * inter_planes, kernel_size=(3, 1), stride=1, padding=(visual, 0), dilation=visual, relu=False)
                )
...
class InLD(nn.Module):
    def __init__(self, in_channels, num_dilated, num_classes):
        ...
        self.rfb = BasicRFB(in_channels, in_channels, scale=1.0, visual=2)
    ...
    def _init_weights(self):
        layers = [self.rfb, self.conv1_1, self.mask, self.dot_layer]
        for layer in layers:
